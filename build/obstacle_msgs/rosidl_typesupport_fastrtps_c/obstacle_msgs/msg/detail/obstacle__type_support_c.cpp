...
#include "obstacle_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacle__ros_msg_type = obstacle_msgs__msg__Obstacle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = obstacle_msgs__msg__Obstacle;
    is_plain =
      (
      offsetof(DataType, is_dynamic) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const obstacle_msgs__msg__Obstacle * ros_message = static_cast<const obstacle_msgs__msg__Obstacle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_obstacle_msgs__msg__Obstacle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  obstacle_msgs__msg__Obstacle * ros_message = static_cast<obstacle_msgs__msg__Obstacle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_obstacle_msgs__msg__Obstacle(cdr, ros_message);
}

static uint32_t _Obstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_obstacle_msgs__msg__Obstacle(
...
static size_t _Obstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_obstacle_msgs__msg__Obstacle(
