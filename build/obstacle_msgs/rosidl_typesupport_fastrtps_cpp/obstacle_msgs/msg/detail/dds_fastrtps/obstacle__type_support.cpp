...
#include "obstacle_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = obstacle_msgs::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const obstacle_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<obstacle_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  return &obstacle_msgs::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
